    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative">
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          <p className="tex-gray-400 text-lg mb-8 max-w-lg mx-auto">I’m a high-motivated and passionate software developer who loves crafting clean, scalable web applications. My job is to help company to build solutions that meet requirement, opearte database, manage API in backend and develop a user-friendly interface.</p>
