      ...
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FlipCard title="Full Stack Web Developer " company="WaterWerks" period="2021 – 2022" details={["• Optimized and Maintained large-scale WordPress websites. ", "• Customized block-based foundation theme with new functions. ", "• Built a single-page application using React and storing data using MongoDB. ", "• Developed back-end API server using Node.js, Express. "]} />
            <FlipCard title="Full Stack Web Developer " company="JAC " period="2019 – 2021" details={["• Maintained and developed small-scale WordPress websites. ", "• Developed and customized foundation theme with different block types.", "• Set up domains through cPanel services using AWS and Cloudflare. ", "• Developed different animations, ECharts and canvas to beautify the websites. "]} />
          </div>
        </div>
      </RevealOnScroll>
    </section>
